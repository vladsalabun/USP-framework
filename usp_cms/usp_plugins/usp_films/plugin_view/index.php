...
?>
<h2>Фільми, які справили на мене сильне враження</h2>

<ol>
    <li>Можна додавати свій відгук<li>
    <li>Можна ставити зірочки в номінаціях<li>
    <li>Можна планувати що хочу подивитись<li>
</ol>
<?php
