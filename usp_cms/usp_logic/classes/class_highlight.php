<?php
    ...
    class highlight
    {
        ...
        private static $quote = '#97979e'; // +
        private static $class = '#fff';
        private static $parent = '#1D6F0C';
        private static $number = '#A4AC21';
        private static $comment = '#008036';
        private static $tag_open = '#F00000';
        private static $keywords = '#64b1ff'; // функції пхп array, echo
        private static $function = '#FFF';
        private static $variable = '#4682B4'; // змінні
        private static $constant = '#8C4D03';
        private static $tag_close = '#F00000';
        private static $operators = '#FED570'; // =>
        private static $semi_colon = '#97979e'; // (крапка з комою)
        private static $parenthesis = '#4075ac'; // (дужки)
        private static $return_type = '#E3093F';
        private static $php_function = '#fff';
        private static $curly_braces = '#97979e'; // +
        private static $parameter_type = '#E3093F';
        private static $square_bracket = '#97979e';
        private static $custom_function = '#fff'; // +
